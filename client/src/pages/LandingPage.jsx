        ...
        <div className="landing-body">
            ...
            <section className="hero-section">
                <div className="landing-container hero-content">
                    ...
                    <div className="hero-actions">
                        <a href="https://savifyappnewtrial.vercel.app" className="hero-primary-btn">Start Free <i className="fas fa-arrow-right"></i></a>
            ...
            <section className="cta-section">
                <div className="landing-container" style={{ textAlign: 'center' }}>
                    ...
                    <a href="https://savifyappnewtrial.vercel.app" className="hero-primary-btn" style={{ display: 'inline-flex' }}>
