  ...
  return (
    <div className="landing-body">
      ...
      <section style={{padding:'6rem 2rem',maxWidth:800,margin:'0 auto',textAlign:'center'}}>
        <h1 style={{fontFamily:'var(--font-secondary)',fontSize:'3rem',marginBottom:'2rem'}}>Terms</h1>
        <p style={{color:'#718096',lineHeight:1.8,fontSize:'1.1rem'}}>This page content will be ported from the original TermsPage.html file.</p>
